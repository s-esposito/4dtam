...
class GaussianModel:
    def __init__(self, sh_degree: int, config=None, is_2dgs=False):
        ...
        self.covariance_activation = (
            self.build_covariance_from_scaling_rotation_2dgs
            if is_2dgs
            else self.build_covariance_from_scaling_rotation
        )
    ...
    def build_covariance_from_scaling_rotation_2dgs(
    ...
    def create_pcd_from_image_and_depth(self, cam, rgb, depth, init=False):
        ...
        # downsample_factor = 1.0 if init else downsample_factor
        ...
        if self.is_2dgs and cam.normal_raw is not None:
        ...
        scales = scales.repeat(1, 2) if self.is_2dgs else scales.repeat(1, 3)
